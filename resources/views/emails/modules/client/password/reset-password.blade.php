                ...
                <td class="email-body" width="570" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <div class="f-fallback">
                            ...
                            <p class="text-base">Has recibido este correo electrónico porque has solicitado restablecer tu contraseña en IDEIA. Este código de verificación expirará en {{ $data['expireInHours'] }} hora(s).
                            </p>
                            ...
                            <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                    <tr>
                                    <td align="center">
                                        <a href="{{ $data['action_url'] }}" class="f-fallback button" target="_blank" style="color: #fff;">Restablecer Contraseña</a>
                                    </td>
                                    </tr>
                                </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <p class="text-sm-light">Si no has solicitado restablecer tu contraseña, por favor ignora este correo electrónico. Si necesitas ayuda, contáctanos a través de soporte@ideia.com.
                                    </p>
                                    <p class="text-sm-light">Por favor, ten en cuenta que este enlace es válido por {{ $data['expireInHours'] }} hora(s). Si no lo usas antes de que expire, tendrás que solicitar otro correo electrónico de restablecimiento de contraseña.                                    </p>
                                    <p class="text-sm-light">Gracias por utilizar IDEIA. </p>
