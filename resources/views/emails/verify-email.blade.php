...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Verifica tu cuenta en TOI</title>
    ...
    <body>
        <span class="preheader">Estas recibiendo este correo para verificar tu nueva cuenta en TOI.</span>
                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        <h1 class="text-title">Verifica tu cuenta en TOI</h1>
                                        {{-- <p class="text-base">Recibes este correo para verificar tu cuenta en TOI. Click en el enlace y pega el siguiente código en la aplicación para continuar con el proceso de registro.</p> --}}
                                        <p class="text-base">Recibes este correo para verificar tu cuenta en TOI.
